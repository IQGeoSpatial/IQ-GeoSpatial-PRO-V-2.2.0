...
EXPEDIENTE_STRUCTURE = {
    ...
    "children": [
            ...
            "children": [
                {
                    ...
                    "children": [
                        ...
                        {"name": "Certificado_Punto_Base.pdf", "type": "file", "aliases": ["certificadopuntobase.pdf"], "optional": False, "children": []},
                    ]
                },
                {
                    "name": "2. Efemerides",
                    ...
                    "children": [
                        ...
                        {"name": "*.SP3", "type": "file", "aliases": ["*.sp3", "*.sp3.gz"], "optional": False, "children": []}
                    ]
                },
                {
                ...
                {"name": "Sustento_Altura_Antena.pdf", "type": "file", "aliases": ["sustentoalturaantena.pdf"], "optional": False, "children": []},
            ]
        },
        {
            "name": "3. FOTOGRAFIAS",
        ...
        "optional": True,   # 👈 Ahora siempre se valida
        "children": [
